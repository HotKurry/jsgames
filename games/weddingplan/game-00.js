...
Game.TileSet = function(columns, tile_size) {
  ...
  this.frames = [new f(3,  225, 13, 30, 0, -16), // idle-left
                 new f(3,  225, 13, 30, 0, -16), // jump-left
                 new f(35,  225, 13, 30, 0, -16), new f(67,  225, 13, 30, 0, -16), new f(98,  225, 13, 30, 0, -16), new f(130,  225, 13, 30, 0, -16), // walk-left
                 new f(  3, 193, 13, 30, 0, -16), // idle-right
                 new f( 3, 193, 13, 30, 0, -16), // jump-right
                 new f( 35, 193, 13, 30, 0, -16), new f( 67, 193, 13, 30, 0, -16), new f( 98, 193, 13, 30, 0, -16), new f( 130, 193, 13, 30, 0, -16) // walk-right
                ];
...
Game.World = function(friction = 0.85, gravity = 1.8) {
  ...
  this.tile_set  = new Game.TileSet(8, 32);
